  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
		...
		<p> Op deze pagina komt u meer te weten over Joas.
		<br>
		druk op een knop van een bepaald onderwerp, om meer informatie te krijgen.</p>
      </div>
    </div>
	<div>
	<button class="btn btn-success" type="button" data-toggle="collapse" data-target="#demo"> Cijfers die behaald zijn</button>
	<div id="demo" class="collapse container-fluid left row" style="width: 30%; margin-left: 0px;">
  Hier kunt u alle cijfers zien die behaald zijn door Joas.
</div>
